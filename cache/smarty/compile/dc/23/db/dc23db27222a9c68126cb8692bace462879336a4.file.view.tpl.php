<?php /* Smarty version Smarty-3.1.14, created on 2014-04-07 17:12:48
         compiled from "/var/www/html/swm.com.co/laravel/public/sw/panel/themes/default/template/controllers/import/helpers/view/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11689648035342c070a607c8-58822509%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dc23db27222a9c68126cb8692bace462879336a4' => 
    array (
      0 => '/var/www/html/swm.com.co/laravel/public/sw/panel/themes/default/template/controllers/import/helpers/view/view.tpl',
      1 => 1395083864,
      2 => 'file',
    ),
    'a4a357787dc24567789401b24b8372f2233ab981' => 
    array (
      0 => '/var/www/html/swm.com.co/laravel/public/sw/panel/themes/default/template/helpers/view/view.tpl',
      1 => 1395083864,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11689648035342c070a607c8-58822509',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5342c070b32123_74574130',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5342c070b32123_74574130')) {function content_5342c070b32123_74574130($_smarty_tpl) {?>

<div class="leadin"></div>


	<script type="text/javascript">
		var errorEmpty = '<?php echo smartyTranslate(array('s'=>'Please name your mapping configuration in order to save it.','js'=>1),$_smarty_tpl);?>
';
		var current = 0;
 ...
 - 1;
	...
	<div id="container-customer" class="panel">
		...
		<div class="alert alert-info">
			<p><?php echo smartyTranslate(array('s'=>'Please map each column of your source CSV file to one of the destination columns.'),$_smarty_tpl);?>
</p>
		</div>
		<div class="form-horizontal">
			<div class="form-group" <?php if (!$_smarty_tpl->tpl_vars['import_matchs']->value){?>style="display:none"<?php }?>>
				<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Load a mapping configuration'),$_smarty_tpl);?>
</label>
...
"><?php echo $_smarty_tpl->tpl_vars['match']->value['name'];?>
			...
			<div class="form-group">
				<label class="control-label col-lg-3" for="newImportMatchs"><?php echo smartyTranslate(array('s'=>'Save your mapping configuration'),$_smarty_tpl);?>
</label>
				<div class="col-lg-7">
		...
		<div id="error_duplicate_type" class="alert alert-warning" style="display:none;">
			<?php echo smartyTranslate(array('s'=>'Columns cannot have the same value type'),$_smarty_tpl);?>

		</div>
		<div id="required_column" class="alert alert-warning" style="display:none;">
			<?php echo smartyTranslate(array('s'=>'Column'),$_smarty_tpl);?>
